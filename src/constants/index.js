...
export const NAV_ITEMS = [
  ...
  { to: '/admin/templates', tKey: 'nav.templates', label: 'Templates', icon: 'FileText', roles: ['admin'] },
  ...
  { to: '/notary', tKey: 'nav.notaryServices', label: 'Notary Services', icon: 'Stamp', roles: ['admin'], end: true },
