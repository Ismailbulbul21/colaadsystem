...
import {
  ...
  BarChart3, Search, Circle, DatabaseBackup, FileClock, Archive, Map, FileBarChart, FileSpreadsheet, Calculator,
} from 'lucide-react'
...
const ICONS = {
  LayoutDashboard, BadgePercent, Users, Briefcase, Settings, ScrollText,
  UserPlus, Inbox, FolderOpen, Wallet, ReceiptText, FileText, TrendingDown,
  BarChart3, Search, DatabaseBackup, FileClock, Archive, Map, FileBarChart, FileSpreadsheet, Calculator,
}
